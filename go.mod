...
require (
	...
	github.com/siderolabs/talos/pkg/machinery v1.3.0-alpha.2.0.20221117200910-6430ce1efcd8
...
require (
	...
	github.com/siderolabs/gen v0.4.2 // indirect
